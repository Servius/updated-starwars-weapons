...
weaponVaporize = CreateConVar("sw_enable_vaporize","0",vaporize_convar_flags,"Enable/Disable the vaporize function for Updated Star Wars Weapons.")

local stun_convar_flags = bit.bor(FCVAR_REPLICATED, FCVAR_NOTIFY, FCVAR_ARCHIVE)
weaponStun = CreateConVar("sw_enable_stun","0",stun_convar_flags,"Enable/Disable the stun function for Updated Star Wars Weapons.")

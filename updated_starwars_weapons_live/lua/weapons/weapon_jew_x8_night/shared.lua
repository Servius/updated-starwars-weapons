...
if ( CLIENT ) then
	...
	SWEP.Slot				= 2
	SWEP.SlotPos			= 3
	SWEP.WepSelectIcon = surface.GetTextureID("HUD/killicons/x8_night")
	
	killicon.Add( "weapon_jew_x8_night", "HUD/killicons/x8_night", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel = "models/weapons/jew/c_x8night.mdl"
...
SWEP.IronSightsPos = Vector(-5.577, -18.431, 2.753)
SWEP.IronSightsAng = Vector(-44.001, -5.716, 0)

--SWEP.ViewModelBoneMods = {
--	["v_dl44_reference001"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
--}

--SWEP.VElements = {
--	["x8_night"] = { type = "Model", model = "models/weapons/jew/x8sniper.mdl", bone = "v_dl44_reference001", rel = "", pos = Vector(-0.076, -3.039, 1.838), angle = Angle(0, -173.926, -6.619), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
--}

SWEP.WElements = {
	["x8_night"] = { type = "Model", model = "models/weapons/jew/x8sniper.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.934, 1.208, -3.674), angle = Angle(0, -97.08, 174.156), size = Vector(1.1, 1.049, 1.049), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

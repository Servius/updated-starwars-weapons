...
SWEP.Purpose			= "Heal players that stand inside the bacta vapor."
...
SWEP.WepSelectIcon = surface.GetTextureID("HUD/killicons/bacta_grenade")

killicon.Add( "weapon_bacta_grenade", "HUD/killicons/bacta_grenade", Color( 255, 80, 0, 255 ) )
...
function SWEP:PreDrawViewModel( vm )
     vm:SetMaterial("models/weapons/v_models/grenades/bacta_grenade")
end
...
function SWEP:DrawWorldModel()
	self:DrawModel()
	self:SetMaterial("models/weapons/v_models/grenades/bacta_grenade")
end

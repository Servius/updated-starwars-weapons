...
if ( CLIENT ) then
	...
	SWEP.Slot				= 4
	SWEP.SlotPos			= 5
	SWEP.WepSelectIcon = surface.GetTextureID("hud/killicons/ion_disruptor")
	
	killicon.Add( "weapon_jew_iondisruptor", "hud/killicons/ion_disruptor", Color( 255, 80, 0, 255 ) )
...
SWEP.VElements = {
	["ion_disruptor"] = { type = "Model", model = "models/weapons/jew/ion_disruptor_.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-0.686, 1.513, 2.986), angle = Angle(0, 1.08, -2.427), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["ion_disruptor"] = { type = "Model", model = "models/weapons/jew/ion_disruptor_.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.218, 1.062, -4.06), angle = Angle(0, -90, 170), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.MuzzleEffect			= "phaser_muzzle"

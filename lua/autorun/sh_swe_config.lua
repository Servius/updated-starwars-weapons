local vaporize_convar_flags = bit.bor(FCVAR_NOTIFY, FCVAR_ARCHIVE)
...
local stun_convar_flags = bit.bor(FCVAR_NOTIFY, FCVAR_ARCHIVE)
...
local scalpel_convar_flags = bit.bor(FCVAR_NOTIFY, FCVAR_ARCHIVE)
